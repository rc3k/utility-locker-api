    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', djmoney.models.fields.MoneyField(decimal_places=2, default_currency='GBP', max_digits=10)),
                ('type', models.CharField(choices=[('electrical', 'Electrical'), ('electronics', 'Electronics'), ('voucher', 'Voucher'), ('book', 'Book'), ('running', 'Running'), ('ceramics', 'Ceramics'), ('casual', 'Casual')], max_length=12)),
